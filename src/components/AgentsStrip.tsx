    ...
    <section className="border-y border-border" aria-label="Supported agents">
      <div className="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6">
        {AGENTS.map((name) => (
          <div
            key={name}
            className="flex items-center justify-center px-3 py-5 select-none border-b border-r border-border/70 last:border-r-0 [&:nth-child(2n)]:border-r-0 sm:[&:nth-child(2n)]:border-r sm:[&:nth-child(3n)]:border-r-0 md:[&:nth-child(3n)]:border-r md:[&:nth-child(6n)]:border-r-0 md:border-b-0"
          >
